...
return [
    ...
    "The input contains non alphabetic characters" => "Chỉ được chứa chữ cái",
    "The input is an empty string" => "The input is an empty string",
    ...
    // Zend\Validator\Csrf
    "The form submitted did not originate from the expected site" => "Đã gửi đến từ nơi không phù hợp với nội dung của trang gốc hoặc hết thời gian",
    ...
    "No record matching the input was found" => "Không thấy dữ liệu phù hợp trong Database",
    "A record matching the input was found" => "Dữ liệu đã có trong Database, chọn dữ liệu khác",
    ...
    "Invalid type given. String expected" => "Sai dữ liệu",
    "The input is not a valid email address. Use the basic format local-part@hostname" => "Email phải có dạng local-part@hostname",
    "'%hostname%' is not a valid hostname for the email address" => "'%hostname%' không phải là hostname cho email",
    "'%hostname%' does not appear to have any valid MX or A records for the email address" => "'%hostname%' MX không phù hợp",
    ...
    "The input exceeds the allowed length" => "chiều dài quá quy định",
    ...
    "The two given tokens do not match" => "Hai khóa không khớp",
    "No token was provided to match against" => "Hai khóa không khớp nhau",

    // Zend\Validator\InArray
    "The input was not found in the haystack" => "Giá trị không có trong danh sách",
    ...
    "Value is required and can't be empty" => "Không được để trống",
    ...
    "Invalid type given. String expected" => "Phải là dữ liệu chuỗi",
    "The input is less than %min% characters long" => "Không được nhỏ hơn %min% ký tự",
    "The input is more than %max% characters long" => "Không được lớn hơn %max% ký tự",
