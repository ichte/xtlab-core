...
class LatinLowCase implements FilterInterface {

    //precomposed - dung san
    //decomposed - to hop
    ...
    {        
        $valueFiltered = str_replace(self::$decomposed, self::$latin, str_replace(self::$precomposed, self::$latin, $value));
